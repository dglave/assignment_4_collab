...
year_compare_graph <- 
  ggplot(data = year_compare, aes(x = size_mm, 
                                  fill = year)) +
  geom_density(alpha = 0.4, color = "#F9CDAD") +
  facet_wrap("site") +
  theme_bw() +
  scale_fill_manual(values = c("#E1F5C4", "#45ADA8")) +
...
# Hey gabe! Trying to remake this table getting a super strange error I can't figure out 
